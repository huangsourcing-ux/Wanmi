...
export function GoogleIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={cn('h-5 w-5', className)}>
      <path
        fill="#4285F4"
        d="M22.5 12.2c0-.7-.1-1.4-.2-2.1H12v4h5.9a5 5 0 01-2.2 3.3v2.7h3.6c2.1-2 3.2-4.9 3.2-8z"
      />
      <path
        fill="#34A853"
        d="M12 23c2.9 0 5.4-1 7.2-2.6l-3.6-2.7c-1 .7-2.2 1-3.6 1-2.8 0-5.1-1.9-6-4.4H2.3v2.8A11 11 0 0012 23z"
      />
      <path fill="#FBBC05" d="M6 14.3a6.6 6.6 0 010-4.2V7.3H2.3a11 11 0 000 9.8L6 14.3z" />
      <path
        fill="#EA4335"
        d="M12 5.4c1.6 0 3 .5 4.1 1.6l3.1-3.1A11 11 0 002.3 7.3L6 10.1c.9-2.6 3.2-4.5 6-4.5z"
      />
    </svg>
  )
}
...
export function EyeOffIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M4 4l16 16M10.6 10.7a3 3 0 004.2 4.2M9.4 5.3A9.8 9.8 0 0112 5c6.5 0 10 7 10 7a17 17 0 01-3.3 4M6.2 7.3A17 17 0 002 12s3.5 7 10 7c1 0 2-.2 2.8-.4"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function HelpFilesIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true" className={cn('h-11 w-11', className)}>
      <rect x="9" y="6" width="24" height="34" rx="3" stroke="currentColor" strokeWidth="2.6" />
      <path
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true" className={cn('h-11 w-11', className)}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M28 8v12h12" stroke="currentColor" strokeWidth="2.6" strokeLinejoin="round" />
      <path d="M16 28h16M16 35h11" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" />
    </svg>
  )
}
...
export function LogoIcon({ className }: IconProps) {
  return (
    ...
    <span
      className={cn('inline-flex h-[34px] w-[146px] items-center gap-2 text-[#EBF3FF]', className)}
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/home/seo/favicon.svg"
        alt=""
        aria-hidden="true"
        width={34}
        height={34}
