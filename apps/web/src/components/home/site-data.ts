...
export const SEARCH_TABS = ['Register', 'Transfer', 'AI Search', 'Bulk Search'] as const
...
export const FAQS: FaqEntry[] = [
  ...
  {
    question: 'How long does it take for a new domain name to be active after registering it?',
    answer: [
  ...
  {
    question: "How do I access and manage my domain settings once it's registered?",
    answer: [
  ...
  {
    question: 'If I register a domain, do I have to put my real name/address in Whois?',
    answer: [
