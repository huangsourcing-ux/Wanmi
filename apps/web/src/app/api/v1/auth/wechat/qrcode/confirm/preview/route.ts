...
import { previewWechatQrConfirmation } from '@/services/auth/wechat'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return successResponse(await previewWechatQrConfirmation(req, input.confirmationToken), traceId)
  } catch (error) {
