...
describe('D7 operations monitoring persistence', () => {
  ...
  it('uses a PostgreSQL CAS so five concurrent executions emit one alert for one closed window', async () => {
    const thresholds = operationsMonitoringThresholdsSchema.parse({
      ...DEFAULT_OPERATIONS_MONITORING_THRESHOLDS,
      balance: { alertCount: 1_000_000, maximumObservationAgeMinutes: 30 },
      documents: { accessCount: 1_000_000, distinctDocumentCount: 1_000_000 },
      fulfillment: {
        failedOrUnknownCount: 1_000_000,
        staleSubmittedCount: 1_000_000,
        staleSubmittedMinutes: 30,
      },
      orders: { maximumOpenAgeMinutes: 30 * 24 * 60, openManualReviewCount: 1_000_000 },
      payments: { openManualReviewCount: 1_000_000 },
      reconciliation: { differenceCount: 1_000_000 },
      refunds: {
        failedOrUnknownCount: 1_000_000,
        staleSubmittedCount: 1_000_000,
        staleSubmittedMinutes: 30,
      ...
      sms: {
        ...
        minimumAttempts: 1_000_000,
        unknownCount: 1_000_000,
      },
      tools: {
        failureRateBasisPoints: 10_000,
        firstPartyFailureCount: 1_000_000,
        minimumRequests: 1_000_000,
        rejectedCount: 1_000_000,
        timeoutCount: 1,
      },
    })
