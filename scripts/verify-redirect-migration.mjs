...
try {
  ...
  postgres([
    ...
    `UPDATE payload_migrations SET batch = 113
     WHERE name = '20260809_024806_d6_active_renewals'`,
  ])
  run('pnpm', ['--filter', '@wanmi/web', 'payload', 'migrate:down'])
  ...
  if (activeRenewalsAfterDown !== 'true:true:true') {
