.PHONY: bootstrap dev worker generate verify-generated verify-oss-real verify-migrations verify-nginx fmt lint test test-integration test-e2e security build smoke check down
