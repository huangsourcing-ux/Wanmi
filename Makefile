.PHONY: bootstrap dev worker rebuild validate-rebuild-local generate verify-generated verify-oss-real verify-migrations verify-nginx verify-operations verify-provider-write-policy verify-rebuild verify-release fmt lint test test-integration test-e2e performance security build smoke check down
...
check: verify-provider-write-policy verify-generated verify-migrations verify-nginx verify-operations verify-rebuild verify-release lint test test-integration security build
