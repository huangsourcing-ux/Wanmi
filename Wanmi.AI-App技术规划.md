...
2026-08-18 的 Web `P1-BASELINE-2026-08-18.1` / `p1-docs-approved-2026-08-18-1` 显式链回 `P1-BASELINE-2026-08-17.2` / `p1-docs-approved-2026-08-17-2`，把 A4 域名管理密码保护对齐为 step-up、active 绑定渠道存在性校验与事后逐 provider 告知，不实施执行前渠道确认；项目负责人明确接受会话被盗时只能事后获知、不能执行前阻断的安全后果。本同步不批准 App、App 域名管理或任何 App 新能力。
...
| 版本 | 日期 | 结论 |
| --- | --- | --- |
| v3.2 | 2026-08-18 | App 仍不进入 P0、P1 或默认 P2；仅同步 Web A4 管理密码保护措辞对齐及不实施执行前渠道确认的负责人决定，不批准 App 能力或改变独立评审门槛 |
